    ...
    return (
      <>
        ...
        <Sheet open={chatMode} onOpenChange={(open) => !open && closeChat()}>
          <SheetContent 
            side="bottom" 
            className="h-[90vh] p-0 bg-black/80 backdrop-blur-xl border-t border-white/20 rounded-t-3xl"
          >
            <ChatWidget
              endpoint={CHAT_ENDPOINT}
              title="Talk with Tommy's AI"
              welcome="Hi! 👋 Ask me about Tommy's work, projects, or resume. I have access to his full background and can give you specific details."
              speakReplies={true}
              onClose={closeChat}
            />
          </SheetContent>
