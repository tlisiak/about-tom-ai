      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed animate-in slide-in-from-bottom-6 duration-700 delay-200 drop-shadow">
            I'm Tommy, a product leader focused on the intersection of AI and impact. At{" "}
            <a
              href="https://scoutclimate.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white font-semibold drop-shadow hover:text-white/80 transition-colors"
            >
              Scout
            </a>
            , I lead product to help mission-driven companies win non-dilutive funding. Thanks for stopping by my little
            corner of the web!
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-in slide-in-from-bottom-8 duration-700 delay-400">
          ...
          <Button
            variant="glass"
            size="lg"
            className="border-orange-300/60 hover:border-orange-200 hover:bg-orange-500/20"
            asChild
          >
